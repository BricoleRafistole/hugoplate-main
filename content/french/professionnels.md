...
## Vaste domaine d'expertise

J’interviens pour les clients professionnels sur diverses installations : appareils de cuisine (hors circuit frigorigène), équipement industriel, matériel de laboratoire, sonorisation, outillage…
  ...
  <div class="row">
    <div class="md:col-6 lg:col-4 mb-14">
      <div class="bg-theme-light dark:bg-darkmode-theme-light rounded p-8 text-center">
        ...
        <p class="mb-4">
          “J’ai fait appel à Valentin pour un problème électronique sur mon tracteur. Après un état des lieux et une concertation claire, Valentin a réalisé un travail soigné en toute autonomie malgrès des conditions de travail pas idéales. Résultat les brebis ont pu manger le soir même. Encore merci !"
        </p>
      </div>
    </div>
  </div>
